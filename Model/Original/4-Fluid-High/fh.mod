...
var pi, ahat, uhat, chat, i, dm, m, nhat, xhat, l, h, w; 
varexo ea, ed, em, el;

%----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
parameters alp, bet, phi, chi, lam, theta, gam, e, B, M, x, g, u, delt, rhoa, rhod, rhol, rhom, psi, rho, net0, net1, h0, hL, hF, k0, kL, kF, phip, phic, phiu;
%----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
x = 0.67; 						% labour market tightness index
...
%(1-u)*delt*xhat=-uhat+(1-x)*(1-delt)*uhat(-1); 															% relation between labour market tightness and employment
